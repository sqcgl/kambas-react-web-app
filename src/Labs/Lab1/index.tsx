...
tag to tell browsers to render the gaps.
            ...
            <div id = "wd-images">
                ...
                <br />
                <img id="wd-teslabot" src="images\Gear-Tesla-Bot.webp" height="200px" />
            </div>
            <div id = "wd-forms">
                <h4>Form Elements</h4>
                <form id = "wd-text-fields">
                    ...
                    <input type="range" id="wd-text-fields-rating" placeholder="Doe" max="5" value="3"/><br/>
