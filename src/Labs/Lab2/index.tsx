...
export default function Lab2() {
  return (
    <div id="wd-lab2" className="container">
      ...
      <div className="wd-css-document-structure">
        <div className="wd-selector-1">
          <h3>Document structure selectors</h3>
          <div className="wd-selector-2">
            Selectores can be combined to refer elements in particular places in
            the document
            <p className="wd-selector-3">
              This paragraph's red background is referenced as <br />
              .selector-2 .selector-3 <br />
              meaning the descendant of some ancestore. <br />
